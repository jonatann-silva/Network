...
const (
	// DefaultAddress is the default DSN server address.
...
// Config contains configurations for DSN's API client.
type Config struct {
	// URL of the DSN server (e.g. http://127.0.0.1:8080).
	Address string
...
// DefaultConfig returns a default configuration for DSN's API client.
