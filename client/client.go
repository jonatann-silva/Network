...
import (
	...
	nic "jonatann-silva/network/client/nic"
	state "jonatann-silva/network/client/state"
	boltdb "jonatann-silva/network/client/state/boltdb"
...
// New is used to create a new DSN client from the
...
func (c *Client) setupState() error {
	...
	if c.config.StateDir != "" {
		...
		tmp, err := c.createTempDir("DSNClient")
		if err != nil {
