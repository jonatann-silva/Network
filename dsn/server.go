...
import (
	...
	"jonatann-silva/network/dsn/state/etcd"
	structs "jonatann-silva/network/dsn/structs"
	"jonatann-silva/network/dsn/structs/config"
	acl "jonatann-silva/network/pkg/acl"
	log "jonatann-silva/network/pkg/log"
	rpc "jonatann-silva/network/pkg/rpc"
	"jonatann-silva/network/pkg/uuid"
)
...
// NewServer creates a new DSN server from the
...
// returns the ACL policies to be loaded by default into the ACL when the DSN server starts.
