...
import (
	...
	mock "jonatann-silva/network/dsn/mock"
	inmem "jonatann-silva/network/dsn/state/inmem"
	structs "jonatann-silva/network/dsn/structs"
	uuid "jonatann-silva/network/pkg/uuid"
)

var config = &dsn.Config{}
...
func TestACLBootstrap(t *testing.T) {
	...
	service := dsn.NewACLService(config, state, authHandler)
